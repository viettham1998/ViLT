...
def main(_config):
    ...
    def infer(url, text):
        ...
        if check.lang == 'vi':
            text_tmp = translate.translate(text, src='vi', dest='en')
            text_input = text_tmp.text
        else:
            text_input = text
        batch = {"text": [text_input], "image": [img]}
        ...
        if check.lang == 'vi':
            answer_tmp = translate.translate(answer, src='en', dest='vi')
            answer_output = answer_tmp.text
        else:
            answer_output = answer
        return [np.array(image), answer_output]
